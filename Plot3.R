...
#************************************************************************************************************
#
#       Plot 3:  Reconstruct a graph that shows Global Active Power amount of energy sub metering per Thurs, Fri, Sat
#                       color code sub meter 1 black, sub meter 2 red and sub meter 3 blue
#
#************************************************************************************************************
cat("\nReconstructing Graph 3")
...
dev.off()        
cat("completed.  Please look in your working directory for the Plot3.png file to see the graph")
