...
#************************************************************************************************************
#
#       Plot 2:  Reconstruct a graph that shows Global Active Power number of kilowatts per Thurs, Fri, Sat
#
#************************************************************************************************************
cat("\nReconstructing Graph 2")
png("Plot2.png",bg="white")
plot(data$Time,data$Global_active_power,ylab="Global Active Power (kilowatts)",type="l",xlab="")
dev.off()
cat("completed.  Please look in your working directory for the Plot2.png file to see the graph")
